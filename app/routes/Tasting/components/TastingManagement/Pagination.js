...
export const SearchResult = () => {
  ...
  return (
    <Row className="mr-0 d-flex justify-content-between">
      <Col xs={12} sm={4} className="d-flex justify-content-start mb-3 ml-3">
      ...
      <Col  xs={12} sm={4} className="d-flex justify-content-end mt-3">
        <Label>
          <p className={`${classes.font}`}>No items to display</p>
        </Label>
      </Col>
    </Row>
  )
