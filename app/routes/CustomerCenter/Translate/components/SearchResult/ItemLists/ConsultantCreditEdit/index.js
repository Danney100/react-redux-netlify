...
const ConsultantCreditEdit = () => {
  ...
  return (
    <Table striped>
      ...
      <tbody>
        <tr>
          <td className={classes.font2}>Block Portal</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td className={classes.font2}>Block Website</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td className={classes.font2}>Business Type</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
...
export default ConsultantCreditEdit
