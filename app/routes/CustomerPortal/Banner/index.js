...
const Banner = () => {
  ...
  const routeChange = () => {
    history.push('/banner/display-banner-add')
  }
  const context = useContext(AppContext)
  const {setTitle} = context
  useEffect(() => {
    setTitle('Customer Portal >  Banners >  Banner Management')
  }, [])
  ...
  return (
    <div className={`${classes.root} px-3 px-lg-0`}>
      ...
      <CommonDemo
        item="success"
        wrapperClass="mx-0"
        content="The banner management page displays all banners that will be displayed to customers 
        and consultants. The user can create and edit new or existing banners within this interface. 
        The banners display order can also be adjusted using the drag and drop feature. 
        Recommended banner size for desk top: 1300px wide by 200px high for mobile devices: 
        390px wide by 200px high."
      ...
      <Row>
        <Col className="mb-3 d-flex justify-content-end">
          <CommonButton title="Reset" buttonType="cancelButton" />
