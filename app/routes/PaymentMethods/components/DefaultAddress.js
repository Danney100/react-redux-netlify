...
import iconVisa from 'images/commonIcons/visa.jpg'
import iconRemoved from 'images/commonIcons/removed.svg'
import iconEdit from 'images/commonIcons/pencil.svg'
import iconMastercard from 'images/commonIcons/mastercard.jpg'
            ...
            <div tag="h5">
              <Row className="border-bottom mr-2 ml-2">
                <Col xs={10} className="d-flex justify-content-start">
                  <p className={classes.title}>Default Payment Method</p>
                </Col>
        ...
        <Col md="6" className="mt-2">
          <Card
            ...
            <div tag="h5">
              <Row className="border-bottom mr-2 ml-2">
                <Col xs={10} className="d-flex justify-content-start">
                  <p className={classes.subtitle}>Additional Payment Method1</p>
                </Col>
                <Col xs={2} className="d-flex justify-content-end">
                  <div className={`${classes.edit} d-flex flex-row`}>
                    <div>
            ...
            <div className={`${classes.root} ml-4 mr-4`}>
              <Row className="border-bottom">
                ...
                <Col xs={10}></Col>
                <Col xs={2} className={`${classes.mastercard} d-flex justify-content-end`}>
                  <div className="ml-4">
