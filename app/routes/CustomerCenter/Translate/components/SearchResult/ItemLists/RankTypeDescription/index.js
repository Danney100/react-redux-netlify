...
const RankTypeDescription = () => {
  ...
  return (
    <Table striped>
      ...
      <tbody>
        <tr>
          <td className={classes.font2}>Executive Consultant</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td className={classes.font2}>Executive Director</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td className={classes.font2}>Executive Manager</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
...
export default RankTypeDescription
