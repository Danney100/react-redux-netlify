      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                Convey meaning through color with a handful of color utility classes. Includes
                support for styling links with hover states, too.
              </React.Fragment>
            }
          />
        </Col>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Use any of these color variables as they are or reassign them to more meaningful
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Grayscale colors provide quick access to commonly used shades of black while
                semantic include various colors assigned to meaningful contextual values.
              </p>
              <div>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text text-justify">
                ...
                quasdam res quas ex communi. At nos hinc posthac, sitientis piros Afros. Petierunt
                uti sibi concilium totius Galliae in diem certam indicere. Cras mattis iudicium
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                ...
                classes, <code>.list-inline</code> and
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Wrap inline snippets of code with <code>&lt;code&gt;</code>. Be sure to escape HTML
                angle brackets.
              </p>
            </CardBody>
          </Card>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                ...
                escape any angle brackets in the code for proper rendering. You may optionally add
                the <code>.pre-scrollable</code> class, \ which will set a max-height of 340px and
                provide a y-axis scrollbar.
              </p>
              <code>
                &lt;p&gt;Sample text here...&lt;/p&gt; &lt;p&gt;And another line of sample text
                here...&lt;/p&gt;
              </code>
            </CardBody>
          </Card>
