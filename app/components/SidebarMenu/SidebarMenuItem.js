...
const SidebarMenuItemLink = (props) =>
  props.to || props.href ? (
    ...
    <div className={`${props.classBase}__entry__link`} onClick={() => props.onToggle()}>
      {props.children}
    </div>
  )
      ...
      <li
        ...
        <SidebarMenuItemLink
          ...
          {entry &&
            ...
            React.cloneElement(this.props.activeIcon, {
              className: classNames(
                this.props.activeIcon.props.className,
